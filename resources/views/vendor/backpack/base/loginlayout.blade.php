...
<body class="hold-transition {{ config('backpack.base.skin') }} sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper" style="background-color: #5093ba; margin-left:0;padding-top: 5%;">
      ...
      <footer class="main-footer" style="margin-left:0; text-align: center;">
        ...
        @endif
       Whizz &copy; 2018. Website developed By <a target="_blank" href="{{ config('backpack.base.developer_link') }}">{{ config('backpack.base.developer_name') }}</a>.
      </footer>
    </div>
    <!-- ./wrapper -->
