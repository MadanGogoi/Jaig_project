...
<?php //dd((date('Z',strtotime('20-03-2019 13:00:00.136 +0800'))/3600));

//dd(timezone_name_from_abbr("",date('Z',strtotime('20-03-2019 13:00:00.136 +0800')),0));?>
@section('header')
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="box">
        ...
        <table id="crudTable" class="table table-striped table-hover display " cellspacing="0">
            <thead>
              <tr>
                {{-- Table columns --}}
