      ...
      jQuery(document).ready(function($) {
        ...
        $('.checklist_dependency').each(function(index, item){
          ...
          thisField.find('.primary_list').change(function(){
            ...
            $('.primary_list').each(function() { 
              if(parseInt($(this).data('id'))!=parseInt(idCurrent)){
                $(this).prop('checked', false) }
                thisField.find('input.primary_hidden[value="'+$(this).data('id')+'"]').remove();

                  // uncheck and active secondary checkboxs if are not in other selected primary.

                  var secondary = dependencyJson[$(this).data('id')];
              ...
              //var res = $("input[name=roles_show[]]").attr('checked', false);
